...
const Dashboard: FC = () => {
  ...
  ship('production');
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 relative z-[1]">
          ...
          <div className="text-center mb-4 sm:mb-6 md:mb-8 animate-fade-in pt-3 sm:pt-4 md:pt-6">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-2 leading-tight px-2" style={{ color: '#fafafa' }}>
              Build. Learn. Create.{' '}
            ...
            <p className="text-xs sm:text-sm md:text-base lg:text-lg max-w-2xl mx-auto px-3" style={{ color: '#d1d1d1' }}>
          ...
          <div className="max-w-2xl mx-auto space-y-3 sm:space-y-4 md:space-y-6">
            ...
            {/* Tech Stack Icons */}
            <div className="flex justify-center items-center gap-3 sm:gap-4 md:gap-6 py-3 sm:py-4 md:py-5 animate-fade-in overflow-x-auto scrollbar-hide" style={{ animationDelay: '50ms', color: '#a1a1a1' }}>
              <div className="hover:opacity-100 opacity-60 transition-all flex-shrink-0">
            ...
            <div className="glass-card p-3 sm:p-4 md:p-6 lg:p-8 animate-fade-in" style={{ animationDelay: '100ms' }}>
              <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold mb-3 sm:mb-4 md:mb-5 lg:mb-6 text-center" style={{ color: '#fafafa' }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="text-center space-y-1.5 sm:space-y-2 p-2 sm:p-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 mx-auto rounded-xl bg-gradient-primary flex items-center justify-center mb-1.5 sm:mb-2 md:mb-3 shadow-lg hover:scale-110 transition-transform">
                    <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                  </div>
                  <h3 className="font-semibold text-xs sm:text-sm md:text-base" style={{ color: '#fafafa' }}>Quick Prototyping</h3>
                  <p className="text-[10px] sm:text-xs md:text-sm leading-snug" style={{ color: '#d1d1d1' }}>Turn ideas into working MVPs in minutes, not days</p>
                </div>
                <div className="text-center space-y-1.5 sm:space-y-2 p-2 sm:p-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 mx-auto rounded-xl bg-gradient-primary flex items-center justify-center mb-1.5 sm:mb-2 md:mb-3 shadow-lg hover:scale-110 transition-transform">
                    <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                  </div>
                  <h3 className="font-semibold text-xs sm:text-sm md:text-base" style={{ color: '#fafafa' }}>Learn by Building</h3>
                  <p className="text-[10px] sm:text-xs md:text-sm leading-snug" style={{ color: '#d1d1d1' }}>Understand code patterns as you create real projects</p>
                </div>
                <div className="text-center space-y-1.5 sm:space-y-2 p-2 sm:p-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 mx-auto rounded-xl bg-gradient-primary flex items-center justify-center mb-1.5 sm:mb-2 md:mb-3 shadow-lg hover:scale-110 transition-transform">
                    <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                  </div>
                  <h3 className="font-semibold text-xs sm:text-sm md:text-base" style={{ color: '#fafafa' }}>Ship Faster</h3>
                  <p className="text-[10px] sm:text-xs md:text-sm leading-snug" style={{ color: '#d1d1d1' }}>Deploy production-ready apps with confidence</p>
                </div>
              </div>
            </div>
