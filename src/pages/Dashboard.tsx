...
const Dashboard: FC = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex w-full">
      ...
      {/* Main Content Area */}
      <div 
        className="flex-1 min-h-screen pb-8 transition-[margin-left] duration-[260ms] ease-[cubic-bezier(0.2,0.9,0.2,1)] ml-[72px] sm:ml-[72px]"
        style={{
          marginLeft: '72px'
        }}
      >
  ...
  ship('production');
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-[1]">
          ...
          <div className="text-center mb-10 animate-fade-in pt-8">
          ...
          <div className="max-w-2xl mx-auto space-y-8">
            ...
            {/* Tech Stack Icons */}
            <div className="flex justify-center items-center gap-8 py-6 animate-fade-in" style={{ animationDelay: '50ms' }}>
            ...
            <div className="glass-card p-8 animate-fade-in" style={{ animationDelay: '100ms' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center space-y-2">
                  <div className="w-14 h-14 mx-auto rounded-xl bg-gradient-primary flex items-center justify-center mb-3 shadow-lg hover:scale-110 transition-transform">
