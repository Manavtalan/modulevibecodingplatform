...
const ChatInterface: FC<ChatInterfaceProps> = ({ conversationId, onConversationCreated, initialPrompt }) => {
  ...
  return (
    <div className="relative max-w-[900px] mx-auto">
      {/* Conversation Popup Window - Appears when messages exist */}
      {messages.length > 0 && (
        <div className="glass-card mb-4 animate-scale-in shadow-elegant">
          {/* Header */}
          <div className="p-3 sm:p-4 border-b border-border/20 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Badge variant="outline" className="text-xs sm:text-sm">Conversation History</Badge>
              {currentConversationId && (
          ...
          {/* Messages Area */}
          <ScrollArea className="h-[400px] px-2 sm:px-4" ref={scrollAreaRef}>
